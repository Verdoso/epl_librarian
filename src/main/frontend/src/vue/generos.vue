<template>
  <section>
    <div>
      <b-field>
        <p class="control">
          ...
          >Solo géneros favoritos</b-switch>
        </p>
      </b-field>
    </div>
    <b-table
    ...
    >
      <b-table-column field="POR_GENERO" label="Nombre" sortable searchable v-slot="props">{{ props.row.nombre }}</b-table-column>
...
export default {
  ...
  methods: {
    ...
    guardarFavoritos() {
      ...
      axios
        .post("/librarian/preferences/generosFavoritos", formData, {
