...
public class Libro {
	...
	public static final SimpleAttribute<Libro, Integer> LIBRO_ID = attribute(Libro.class, Integer.class, LIBRO_ID_PARAM,
			Libro::getId);
	public static final SimpleAttribute<Libro, String> LIBRO_TITULO = attribute(Libro.class, String.class,
			LIBRO_TITULO_PARAM, Libro::getTituloNormalizado);
	public static final SimpleAttribute<Libro, String> LIBRO_AUTOR = attribute(Libro.class, String.class,
	...
	public static final SimpleAttribute<Libro, Boolean> LIBRO_AUTOR_FAVORITO = attribute(Libro.class, Boolean.class,
			LIBRO_AUTOR_FAVORITO_PARAM, Libro::getAutorFavorito);
	public static final SimpleAttribute<Libro, String> LIBRO_IDIOMA = attribute(Libro.class, String.class,
			LIBRO_IDIOMA_PARAM, Libro::getIdiomaNormalizado);
	public static final SimpleAttribute<Libro, Boolean> LIBRO_IDIOMA_FAVORITO = attribute(Libro.class, Boolean.class,
			LIBRO_IDIOMA_FAVORITO_PARAM, Libro::getIdiomaFavorito);
	public static final SimpleAttribute<Libro, Boolean> LIBRO_EN_CALIBRE = attribute(Libro.class, Boolean.class,
			LIBRO_EN_CALIBRE_PARAM, Libro::getInCalibre);
	public static final SimpleAttribute<Libro, Boolean> LIBRO_DESCARTADO = attribute(Libro.class, Boolean.class,
			LIBRO_DESCARTADO_PARAM, Libro::getDescartado);
	public static final SimpleNullableAttribute<Libro, ChronoLocalDate> LIBRO_PUBLICADO = nullableAttribute(Libro.class,
			ChronoLocalDate.class, LIBRO_PUBLICADO_PARAM, Libro::getFechaPublicacion);
	public static final SimpleNullableAttribute<Libro, String> LIBRO_COLECCION = nullableAttribute(Libro.class,
			String.class, LIBRO_COLECCION_PARAM, Libro::getColeccionNormalizada);
	public static final SimpleNullableAttribute<Libro, BigDecimal> LIBRO_VOLUMEN = nullableAttribute(Libro.class,
			BigDecimal.class, LIBRO_VOLUMEN_PARAM, Libro::getVolumen);
	public static final SimpleNullableAttribute<Libro, String> LIBRO_GENERO = nullableAttribute(Libro.class,
			String.class, LIBRO_GENERO_PARAM, Libro::getGeneroNormalizado);
	public static final MultiValueNullableAttribute<Libro, String> LIBRO_GENEROS = nullableAttribute(Libro.class,
			String.class, LIBRO_GENEROS_PARAM, Libro::getListaGenerosNormalizados);
	public static final SimpleAttribute<Libro, Boolean> LIBRO_GENERO_FAVORITO = attribute(Libro.class, Boolean.class,
	...
	public List<String> getListaAutoresNormalizados() {
		if (autor != null) {
			return Arrays.asList(autor.split(" & ")).stream().map(Libro::flattenToAscii).toList();
		} else {
			return Collections.emptyList();
		}
	}
	...
	public List<String> getListaGenerosNormalizados() {
		if (generos != null) {
			return Arrays.asList(generos.split(",")).stream().map(Libro::flattenToAscii).toList();
		} else {
			return Collections.emptyList();
		}
	}
