...
public class LibrarianAPIController {
  ...
  public ResponseEntity<Pagina<Libro>> paginaLibro(@RequestParam(name = "numero_pagina", defaultValue = "0") int numeroPagina,
    ...
    BusquedaLibro busquedaLibro = new BusquedaLibro(numeroPagina, porPagina, ordering, reversed, filtroTitulo, filtroColeccion, filtroAutor,
        filtroGenero, filtroIdioma, filtroFecha, soloAutoresFavoritos, soloIdiomasFavoritos, soloGenerosFavoritos, soloNoEnPropiedad);
