...
public class PreferencesService {
    ...
    private Set<String> leerIdiomasPreferidos(Properties preferences) {
        ...
        try {
            if (preferences.containsKey(IDIOMAS_PREFERIDOS_KEY)) {
                result = new HashSet<>(Stream
                        .of(preferences.getProperty(IDIOMAS_PREFERIDOS_KEY).split(","))
    ...
    private Set<Integer> leerLibrosDescartados(Properties preferences) {
        ...
        try {
            if (preferences.containsKey(LIBROS_DESCARTADOS_KEY)) {
                result = new HashSet<>(Stream
                        .of(preferences.getProperty(LIBROS_DESCARTADOS_KEY).split(","))
                        .filter(StringUtils::isNotBlank)
    ...
    private Set<String> leerAutoresPreferidos(Properties preferences) {
        ...
        try {
            if (preferences.containsKey(AUTORES_PREFERIDOS_KEY)) {
                result = new HashSet<>(Stream
                        .of(preferences.getProperty(AUTORES_PREFERIDOS_KEY).split(","))
                        .filter(StringUtils::isNotBlank)
                        .collect(Collectors.toList()));
            }
        } catch (Exception e) {
    ...
    private Set<String> leerGenerosPreferidos(Properties preferences) {
        ...
        try {
            if (preferences.containsKey(GENEROS_PREFERIDOS_KEY)) {
                result = new HashSet<>(Stream
                        .of(preferences.getProperty(GENEROS_PREFERIDOS_KEY).split(","))
                        .filter(StringUtils::isNotBlank)
                        .collect(Collectors.toList()));
            }
        } catch (Exception e) {
            ...
            if (preferences.containsKey(CALIBRE_HOME_KEY)) {
                ...
                if (temp.exists() && temp.isDirectory()) {
                    ...
                    if (bddCalibre.exists() && bddCalibre.isFile() && bddCalibre.canRead()) {
                        ...
                        log
                                .error("La BDD no se encuentra en el directorio especificado o no es legible: {}. Ignoraremos la configuraci\u00f3n de calibre",
                                        bddCalibre.getAbsolutePath());
                    }
                } else {
                    log
                            .error("El directorio especificado no existe: {}. Ignoraremos la configuraci\u00f3n de calibre",
    ...
    public void setDescarte(Integer libroId, boolean descartado) {
        ...
        try {
            ...
            preferences
                    .setProperty(LIBROS_DESCARTADOS_KEY,
                            this.librosDescartados
                                    .stream()
    ...
    public void actualizarAutoresPreferidos(Set<String> autoresPreferidosToAdd, Set<String> autoresPreferidosToRemove) {
        ...
        try {
            ...
            preferences
                    .setProperty(AUTORES_PREFERIDOS_KEY,
    ...
    public void actualizarIdiomasPreferidos(Set<String> idiomasPreferidosToAdd,
        ...
        try {
            ...
            preferences
                    .setProperty(IDIOMAS_PREFERIDOS_KEY,
    ...
    public void actualizarGenerosPreferidos(Set<String> generosPreferidosToAdd,
        ...
        try {
            ...
            preferences
                    .setProperty(GENEROS_PREFERIDOS_KEY,
    ...
    public static File findPreferencesFile(boolean superPortable) {
        return new File(String
                .join(File.separator, System.getProperty(superPortable ? "user.dir" : "user.home"), ".librarian",
    ...
    public Optional<LocalDate> getFechaBase() {
        ...
        if (fechaBaseString != null) {
            try {
                ...
                log
                        .error("Error parseando fecha base. el formato es DateTimeFormatter.ISO_LOCAL_DATE: {}",
                                e.getMessage());
                log.trace(ERROR_DETALLADO, e);
            }
        }
