...
public class BibliotecaService {
	...
	private BiFunction<String, String, List<Integer>> SEARCH_AND_UDPATE_BOOK = (titulo, autores) -> {
		...
		try (ResultSet<Libro> queryResult = libreria.retrieve(
				BusquedaLibro.getPartialQuery(Libro.tituloComparable(titulo), Libro.LIBRO_TITULO_COMPARABLE))) {
			queryResult.stream().forEach(libro -> {
